...
<html>
  ...
  <body>
    ...
    <form method="post" name="edit_aro_sections" action="edit_aro_sections.php">
      <table cellpadding="2" cellspacing="2" border="2" width="100%">
        <tbody>
          <tr align="center">
            <td valign="top" colspan="5" bgcolor="#cccccc"><b>phpGACL</b> <b>ARO Section
            Administrator</b><br>
             </td>
          </tr>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#cccccc" align="center">
                <input type="text" size="10" name="sections[{$sections[x].id}][]" value="{$sections[x].name}">                
             </td>
            <td valign="top" bgcolor="#cccccc" align="center">
