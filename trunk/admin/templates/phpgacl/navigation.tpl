<div align="center" class="navigation">
  ...
  <a href="acl_admin.php?return_page=acl_admin.php">ACL Admin</a> |
  <a href="acl_list.php?return_page=acl_list.php">ACL List</a> |
  <a href="acl_test.php">ACL Test</a> |
  <a href="acl_debug.php">ACL Debug</a> |
  <a href="about.php">About</a> |
  <a href="../docs/manual.html" target="_blank">Manual</a>
</div>
